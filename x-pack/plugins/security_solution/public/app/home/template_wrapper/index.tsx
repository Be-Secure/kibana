...
import { useSyncFlyoutStateWithUrl } from '../../../flyout/url';
...
export const SecuritySolutionTemplateWrapper: React.FC<Omit<KibanaPageTemplateProps, 'ref'>> =
  React.memo(({ children, ...rest }) => {
    ...
    const [flyoutRef, handleFlyoutChanges] = useSyncFlyoutStateWithUrl();
    ...
    return (
      <ExpandableFlyoutProvider
        onChanges={handleFlyoutChanges}
        onClosePanels={handleFlyoutChanges}
        ref={flyoutRef}
      >
        ...
        >
          ...
          <ExpandableFlyout
            ...
            onClose={() => {}}
            handleOnFlyoutClosed={handleFlyoutChanges}
          />
        </StyledKibanaPageTemplate>
      </ExpandableFlyoutProvider>
    );
